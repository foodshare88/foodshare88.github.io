...
Kirki::add_panel( 'typography', array(
    ...
    'description' => __( 'This panel will provide all the fonts for your website.', 'foodicious' ),
) );
...
Kirki::add_section( 'title_section', array(
    ...
    'description'    => __( 'You can change Website fonts, colors, typography from here.', 'foodicious' ),
...
Kirki::add_field( 'my_custom_text', array(
    ...
    'type'     => 'custom',
    'default'  => __( 'This is only available in Premium Version. <br/><a target="_blank" href="https://www.vinethemes.com/downloads/foodicious-blog-wordpress-theme/"> + Upgrade to Premium Version</a>', 'foodicious' ),
) );
