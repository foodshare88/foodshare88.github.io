...
function foodicious_add_google_fonts() {
    wp_enqueue_style( 'foodicious-playfair-display-google-fonts', 'https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700', false );
    wp_enqueue_style( 'foodicious-open-sans-google-fonts', 'https://fonts.googleapis.com/css?family=Open+Sans:400,600,700', false );
}
